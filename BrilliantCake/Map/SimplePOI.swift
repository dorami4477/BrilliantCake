...
class SimplePOI: TestMapViewController {
    ...
    func createPoiStyle() {
        ...
        let resizedImage = resizeImage(image: UIImage(named: "BC_10")!, targetSize: CGSize(width: 35, height: 45))
    ...
    func createPois() {
        ...
        print(#function, coord.0, coord.1)
